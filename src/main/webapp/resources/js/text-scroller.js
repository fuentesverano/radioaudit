...
pausescroller.prototype.initialize = function() {
	...
	// set width of inner DIVs to outer DIV's width minus padding (padding
	// assumed to be top padding x 2)
...
pausescroller.prototype.setmessage = function() {
	var scrollerinstance = this;
	if (this.mouseoverBol == 1) // if mouse is currently over scoller, do
								// nothing (pause it)
		setTimeout(function() {
			scrollerinstance.setmessage();
		}, 100);
...
pausescroller.getCSSpadding = function(tickerobj) { // get CSS padding value, if
													// any

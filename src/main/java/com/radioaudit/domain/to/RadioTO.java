...
public class RadioTO extends AbstractDTO {
	...
	private List<JingleTO> activeJingles;
	private List<JingleTO> deactivedJingles;
	...
	public List<JingleTO> getActiveJingles() {
		return activeJingles;
	}

	public void setActiveJingles(List<JingleTO> activeJingles) {
		this.activeJingles = activeJingles;
	}

	public List<JingleTO> getDeactivedJingles() {
		return deactivedJingles;
	}

	public void setDeactivedJingles(List<JingleTO> deactivedJingles) {
